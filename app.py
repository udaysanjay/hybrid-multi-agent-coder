...
# ==========================================================
# ADVANCED THEME & LAYOUT CONFIGURATION
# ==========================================================
...
with st.sidebar:
    ...
    st.code(f"Engine: {CLOUD_MODEL}\nType: Multi-Agent v2.0\nRouting: Dynamic Gateway", language="text")
...
# Analytical Metric Trackers Layout
m1, m2, m3 = st.columns(3)
with m1:
    st.markdown('<div class="metric-card"><div class="metric-val">3 Agents</div><div class="metric-lbl">Active Workforce Topology</div></div>', unsafe_with_html=True)
with m2:
...
with m3:
    st.markdown('<div class="metric-card"><div class="metric-val">100% Secure</div><div class="metric-lbl">Environment Vault Execution</div></div>', unsafe_with_html=True)
